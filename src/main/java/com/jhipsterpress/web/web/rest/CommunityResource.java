...
public class CommunityResource {
    ...
    */
    ...
    @Timed
    public ResponseEntity<List<CommunityDTO>> searchCommunities(@RequestParam String query, Pageable pageable) {
        log.debug("REST request to search for a page of Communities for query {}", query);
        Page<CommunityDTO> page = communityService.search(query, pageable);
