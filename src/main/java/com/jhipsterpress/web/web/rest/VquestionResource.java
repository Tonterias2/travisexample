...
public class VquestionResource {
    ...
    */
    ...
    /**
     * SEARCH  /_search/vquestions?query=:query : search for the vquestion corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<VquestionDTO>> searchVquestions(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/vquestions");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
