...
public class VthumbResource {
    ...
    */
    ...
    /**
     * SEARCH  /_search/vthumbs?query=:query : search for the vthumb corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<VthumbDTO>> searchVthumbs(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/vthumbs");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
