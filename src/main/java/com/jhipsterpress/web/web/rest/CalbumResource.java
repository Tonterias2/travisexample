...
public class CalbumResource {
    ...
    */
    ...
    /**
     * SEARCH  /_search/calbums?query=:query : search for the calbum corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<CalbumDTO>> searchCalbums(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/calbums");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
