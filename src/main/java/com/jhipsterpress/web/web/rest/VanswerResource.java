...
public class VanswerResource {
    ...
    */
    ...
    /**
     * SEARCH  /_search/vanswers?query=:query : search for the vanswer corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<VanswerDTO>> searchVanswers(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/vanswers");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
