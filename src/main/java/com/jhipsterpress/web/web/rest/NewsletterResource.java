...
public class NewsletterResource {
    ...
    */
    ...
    /**
     * SEARCH  /_search/newsletters?query=:query : search for the newsletter corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<NewsletterDTO>> searchNewsletters(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/newsletters");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
