...
export class VanswerUpdatePage {
    ...
    urlvanserInput = element(by.id('field_urlvanser'));
    ...
    async setUrlvanserInput(urlvanser) {
        await this.urlvanserInput.sendKeys(urlvanser);
    }

    async getUrlvanserInput() {
        return this.urlvanserInput.getAttribute('value');
    }
