...
describe('Comment e2e test', () => {
    ...
    it('should load Comments', async () => {
        ...
        expect(await commentComponentsPage.getTitle()).to.eq('jhipsterpress09App.comment.home.title');
    });
    ...
    it('should load create Comment page', async () => {
        ...
        expect(await commentUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.comment.home.createOrEditLabel');
    ...
    /* it('should delete last Comment', async () => {
        ...
        expect(await commentDeleteDialog.getDialogTitle())
            .to.eq('jhipsterpress09App.comment.delete.question');
