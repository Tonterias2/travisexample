...
describe('Message e2e test', () => {
    ...
    it('should load Messages', async () => {
        ...
        expect(await messageComponentsPage.getTitle()).to.eq('jhipsterpress09App.message.home.title');
    });
    ...
    it('should load create Message page', async () => {
        ...
        expect(await messageUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.message.home.createOrEditLabel');
    ...
    it('should delete last Message', async () => {
        ...
        expect(await messageDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.message.delete.question');
