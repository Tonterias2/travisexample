...
describe('Frontpageconfig e2e test', () => {
    ...
    it('should load Frontpageconfigs', async () => {
        ...
        expect(await frontpageconfigComponentsPage.getTitle()).to.eq('jhipsterpress09App.frontpageconfig.home.title');
    });
    ...
    it('should load create Frontpageconfig page', async () => {
        ...
        expect(await frontpageconfigUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.frontpageconfig.home.createOrEditLabel');
    ...
    it('should delete last Frontpageconfig', async () => {
        ...
        expect(await frontpageconfigDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.frontpageconfig.delete.question');
