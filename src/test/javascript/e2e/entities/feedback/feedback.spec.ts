...
describe('Feedback e2e test', () => {
    ...
    it('should load Feedbacks', async () => {
        ...
        expect(await feedbackComponentsPage.getTitle()).to.eq('jhipsterpress09App.feedback.home.title');
    });
    ...
    it('should load create Feedback page', async () => {
        ...
        expect(await feedbackUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.feedback.home.createOrEditLabel');
    ...
    it('should delete last Feedback', async () => {
        ...
        expect(await feedbackDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.feedback.delete.question');
