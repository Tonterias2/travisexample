...
describe('Uprofile e2e test', () => {
    ...
    it('should load Uprofiles', async () => {
        ...
        expect(await uprofileComponentsPage.getTitle()).to.eq('jhipsterpress09App.uprofile.home.title');
    });
    ...
    it('should load create Uprofile page', async () => {
        ...
        expect(await uprofileUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.uprofile.home.createOrEditLabel');
    ...
    /* it('should delete last Uprofile', async () => {
        ...
        expect(await uprofileDeleteDialog.getDialogTitle())
            .to.eq('jhipsterpress09App.uprofile.delete.question');
