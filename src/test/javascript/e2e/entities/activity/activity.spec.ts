...
describe('Activity e2e test', () => {
    ...
    it('should load Activities', async () => {
        ...
        expect(await activityComponentsPage.getTitle()).to.eq('jhipsterpress09App.activity.home.title');
    });
    ...
    it('should load create Activity page', async () => {
        ...
        expect(await activityUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.activity.home.createOrEditLabel');
    ...
    it('should delete last Activity', async () => {
        ...
        expect(await activityDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.activity.delete.question');
