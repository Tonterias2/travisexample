...
export class VquestionUpdatePage {
    ...
    vquestiondescInput = element(by.id('field_vquestiondesc'));
    ...
    async setVquestiondescInput(vquestiondesc) {
        await this.vquestiondescInput.sendKeys(vquestiondesc);
    }

    async getVquestiondescInput() {
        return this.vquestiondescInput.getAttribute('value');
    }
