...
describe('Vquestion e2e test', () => {
    ...
    it('should load Vquestions', async () => {
        ...
        expect(await vquestionComponentsPage.getTitle()).to.eq('jhipsterpress09App.vquestion.home.title');
    });
    ...
    it('should load create Vquestion page', async () => {
        ...
        expect(await vquestionUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.vquestion.home.createOrEditLabel');
    ...
    /* it('should delete last Vquestion', async () => {
        ...
        expect(await vquestionDeleteDialog.getDialogTitle())
            .to.eq('jhipsterpress09App.vquestion.delete.question');
