...
describe('Blockuser e2e test', () => {
    ...
    it('should load Blockusers', async () => {
        ...
        expect(await blockuserComponentsPage.getTitle()).to.eq('jhipsterpress09App.blockuser.home.title');
    });
    ...
    it('should load create Blockuser page', async () => {
        ...
        expect(await blockuserUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.blockuser.home.createOrEditLabel');
    ...
    it('should delete last Blockuser', async () => {
        ...
        expect(await blockuserDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.blockuser.delete.question');
