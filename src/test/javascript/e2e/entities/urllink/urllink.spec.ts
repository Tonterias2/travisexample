...
describe('Urllink e2e test', () => {
    ...
    it('should load Urllinks', async () => {
        ...
        expect(await urllinkComponentsPage.getTitle()).to.eq('jhipsterpress09App.urllink.home.title');
    });
    ...
    it('should load create Urllink page', async () => {
        ...
        expect(await urllinkUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.urllink.home.createOrEditLabel');
    ...
    it('should delete last Urllink', async () => {
        ...
        expect(await urllinkDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.urllink.delete.question');
