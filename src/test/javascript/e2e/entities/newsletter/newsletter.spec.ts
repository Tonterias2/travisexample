...
describe('Newsletter e2e test', () => {
    ...
    it('should load Newsletters', async () => {
        ...
        expect(await newsletterComponentsPage.getTitle()).to.eq('jhipsterpress09App.newsletter.home.title');
    });
    ...
    it('should load create Newsletter page', async () => {
        ...
        expect(await newsletterUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.newsletter.home.createOrEditLabel');
    ...
    it('should delete last Newsletter', async () => {
        ...
        expect(await newsletterDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.newsletter.delete.question');
