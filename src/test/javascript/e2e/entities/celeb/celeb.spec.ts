...
describe('Celeb e2e test', () => {
    ...
    it('should load Celebs', async () => {
        ...
        expect(await celebComponentsPage.getTitle()).to.eq('jhipsterpress09App.celeb.home.title');
    });

    it('should load create Celeb page', async () => {
        await celebComponentsPage.clickOnCreateButton();
        celebUpdatePage = new CelebUpdatePage();
        expect(await celebUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.celeb.home.createOrEditLabel');
    ...
    it('should delete last Celeb', async () => {
        ...
        expect(await celebDeleteDialog.getDialogTitle()).to.eq('jhipsterpress09App.celeb.delete.question');
