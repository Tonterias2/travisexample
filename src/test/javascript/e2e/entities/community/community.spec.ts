...
describe('Community e2e test', () => {
    ...
    it('should load Communities', async () => {
        ...
        expect(await communityComponentsPage.getTitle()).to.eq('jhipsterpress09App.community.home.title');
    });
    ...
    it('should load create Community page', async () => {
        ...
        expect(await communityUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.community.home.createOrEditLabel');
    ...
    /* it('should delete last Community', async () => {
        ...
        expect(await communityDeleteDialog.getDialogTitle())
            .to.eq('jhipsterpress09App.community.delete.question');
