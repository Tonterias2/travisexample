...
describe('Notification e2e test', () => {
    ...
    it('should load Notifications', async () => {
        ...
        expect(await notificationComponentsPage.getTitle()).to.eq('jhipsterpress09App.notification.home.title');
    });
    ...
    it('should load create Notification page', async () => {
        ...
        expect(await notificationUpdatePage.getPageTitle()).to.eq('jhipsterpress09App.notification.home.createOrEditLabel');
    ...
    /* it('should delete last Notification', async () => {
        ...
        expect(await notificationDeleteDialog.getDialogTitle())
            .to.eq('jhipsterpress09App.notification.delete.question');
